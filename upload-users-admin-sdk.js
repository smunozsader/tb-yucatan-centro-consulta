...
// Initialize Firebase Admin using service account JSON file path from .env
const fs = require('fs');
...
try {
  ...
  console.error('❌ Failed to load service account JSON from path:', process.env.FIREBASE_SERVICE_ACCOUNT_KEY);
  console.error(err);
  process.exit(1);
}
